...
createInertiaApp({
    ...
    setup({ el, App, props, plugin }) {
        ...
        // VueApp.config.globalProperties.$ziggyRoute = (route, params, absolute, config = props.initialPage.props.ziggy) => route(route, params, absolute, config);
        ...
        VueApp.component('router-link', RouterLink)
            .component("Link", Link)
            .component("Head", Head)
            // .use(ZiggyVue, Ziggy)
            .use(createPinia())
