        ...
        <div class="col-12">
            <div class="card">
                    ...
                    <template #start>
                        <form @submit.prevent="methods.submit.cari">
                            <div class="p-inputgroup flex-1">
                                <InputText v-model="form.cari" placeholder="Cari Pegawai" />
                ...
                <DataTable :value="data.tables.data" showGridlines tableStyle="min-width: 50rem">
                    ...
                    <Column field="data">
                        <template #header> <span class="flex-1 text-center">Nama</span> </template>
                    ...
                    <Column field="data">
                        <template #header> <span class="flex-1 text-center">Roles</span> </template>
                        <template #body="{ data, frozenRow, index }">
                            <div class="text-center">
...
const ModalFormUser = defineAsyncComponent(() => import('./ModalFormUser.vue'));
    ...
    setup(props) {
        ...
        const fn = {
            reloadPageWithParameter: (params) => {
                router.get('./user', (JSON.parse(JSON.stringify(params), (key, value) => value === null || value === '' ? undefined : value)));
            }
        };
        ...
        const methods = {
            ...
            click: {
                openCloseModal: (dataModal) => {
                    ...
                    globalVariable.$dialog.open(ModalFormUser, {
                        props: {
                            showHeader: false,
                            style: {
                                width: '50vw',
                ...
                delete: (dataUser) => {
                    globalVariable.$confirm.require({
                        message: 'Apakah yakin ingin menghapus user ini?',
                        header: 'Konfirmasi',
                        ...
                        accept: () => {
                            ...
                            globalVariable.$toast.add({ severity: 'success', summary: 'SUKSES', detail: 'Berhasil Hapus User', life: 3000 });
